...
BOOL CScreenSpyDlg::OnInitDialog()
{
	...
	SetClassLong(m_hWnd, GCL_HCURSOR, (LONG)LoadCursor(NULL, IDC_NO));//64位系统已经放弃GCL_HCURSOR
	//SetClassLongPtr(m_hWnd, GCL_HCURSOR, (LONG)LoadCursor(NULL, IDC_NO));
